...
graph TD
    ...
    Log --> GenerateSQL[生成 SQL<br/>generate_sql_node<br/>M1/M3]
    
    GenerateSQL --> Clarify[澄清判断<br/>clarify_node<br/>M7: 新增节点]
    ...
    BuildCritiquePrompt --> CallLLM[调用 LLM<br/>生成错误分析]
    CallLLM --> GenerateCritique[生成 Critique<br/>错误原因 + 修复建议]
    ...
    ModifyPrompt --> CallLLM2[调用 LLM<br/>基于 critique 重新生成]
    CallLLM2 --> IncrementCount[增加重试计数<br/>regeneration_count++]
